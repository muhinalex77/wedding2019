$(document).ready(function() {
	...
	$(".story_wrapper").owlCarousel({
 		navigation : true,	responsive: true, responsiveRefreshRate : 1600,	slideSpeed : 3600,	
 		paginationSpeed : 3600,	rewindSpeed : 8000,	items:3,  itemsTablet: [768,1], autoPlay : false,
